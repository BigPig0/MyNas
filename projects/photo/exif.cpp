...
namespace {
    ...
    private:
        ...
        // Parsed fields
        union {
            std::vector<uint8_t> *val_byte_;
            std::string *val_string_;
            std::vector<uint16_t> *val_short_;
            std::vector<uint32_t> *val_long_;
            std::vector<Rational> *val_rational_;
        };
        ...
        void new_union() {
            switch (format_) {
            case 0x1:
                val_byte_ = new std::vector<uint8_t>();
                break;
            case 0x2:
                val_string_ = new std::string();
                break;
            case 0x3:
                val_short_ = new std::vector<uint16_t>();
                break;
            case 0x4:
                val_long_ = new std::vector<uint32_t>();
                break;
            case 0x5:
                val_rational_ = new std::vector<Rational>();
                break;
            case 0xff:
                break;
            default:
